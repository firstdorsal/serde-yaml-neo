...
impl Number {
    ...
    /// let v: serde_yaml_neo::Value = serde_yaml_neo::from_str(r#"
    /// a: 64
    ...
    /// ```
    /// # fn main() -> serde_yaml_neo::Result<()> {
    /// let v: serde_yaml_neo::Value = serde_yaml_neo::from_str(".inf")?;
    /// assert_eq!(v.as_f64(), Some(f64::INFINITY));
    ///
    /// let v: serde_yaml_neo::Value = serde_yaml_neo::from_str("-.inf")?;
    /// assert_eq!(v.as_f64(), Some(f64::NEG_INFINITY));
    ///
    /// let v: serde_yaml_neo::Value = serde_yaml_neo::from_str(".nan")?;
