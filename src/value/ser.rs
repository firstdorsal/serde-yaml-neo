...
///
/// This is the serializer that backs [`serde_yaml_neo::to_value`][crate::to_value].
/// Unlike the main serde_yaml_neo serializer which goes from some serializable
...
/// ```
/// use serde::Serialize;
/// use serde_yaml_neo::{Error, Value};
///
/// pub fn to_value<T>(input: T) -> Result<Value, Error>
/// where
///     T: Serialize,
/// {
///     input.serialize(serde_yaml_neo::value::Serializer)
/// }
/// ```
