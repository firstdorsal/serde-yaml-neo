...
/// A YAML mapping in which the keys and values are both `serde_yaml_neo::Value`.
...
/// A type that can be used to index into a `serde_yaml_neo::Mapping`. See the
...
/// Iterator over `&serde_yaml_neo::Mapping`.
pub struct Iter<'a> {
...
/// Iterator over `&mut serde_yaml_neo::Mapping`.
...
/// Iterator over `serde_yaml_neo::Mapping` by value.
pub struct IntoIter {
...
/// Iterator of the keys of a `&serde_yaml_neo::Mapping`.
pub struct Keys<'a> {
...
/// Iterator of the values of a `&serde_yaml_neo::Mapping`.
pub struct Values<'a> {
...
/// Iterator of the values of a `&mut serde_yaml_neo::Mapping`.
